 ...
 */
@WebServlet(name = "HotelEquipmentGetterServlet")
public class HotelEquipmentGetterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int hotelId = DataBaseManager.getEmployeeHotelId(connection,userId);
